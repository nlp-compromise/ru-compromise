<div align="center">
  ...
  <div><b>ru-compromise</b></div>
  <img src="https://user-images.githubusercontent.com/399657/68222691-6597f180-ffb9-11e9-8a32-a7f38aa8bded.png"/>
  <div>скромная обработка естественного языка</div>
  <div><code>npm install ru-compromise</code></div>
  <div align="center">
    <sub>
...
<div align="center">
  <div>
    <a href="https://npmjs.org/package/ru-compromise">
    <img src="https://img.shields.io/npm/v/ru-compromise.svg?style=flat-square" />
  </a>
  <!-- <a href="https://codecov.io/gh/spencermountain/ru-compromise">
    <img src="https://codecov.io/gh/spencermountain/ru-compromise/branch/master/graph/badge.svg" />
  </a> -->
  <a href="https://bundlephobia.com/result?p=ru-compromise">
    <img src="https://img.shields.io/bundlephobia/min/ru-compromise"/>
  </a>
  </div>
  <div align="center">
    <sub>
     видеть: <a href="https://github.com/nlp-compromise/it-compromise">итальянский</a> • <a href="https://github.com/nlp-compromise/de-compromise">Немецкий</a> • <a href="https://github.com/nlp-compromise/fr-compromise">французский</a> • <a href="https://github.com/spencermountain/compromise">английский</a>
     • <a href="https://github.com/nlp-compromise/pt-compromise">португальский</a>
    </sub>
  </div>
</div>
...
`ru-compromise` - это порт [compromise](https://github.com/nlp-compromise/compromise) для русского языка
...
```
git clone https://github.com/nlp-compromise/ru-compromise.git
cd ru-compromise
npm install
npm test
npm watch
